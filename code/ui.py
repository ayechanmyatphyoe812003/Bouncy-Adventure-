...
class UI:
    ...
    def display_text(self):
        ...
        # Display unlocked level
        unlocked_level_text = self.font.render(f"Unlocked Level: {self.unlocked_level+1}", False, '#33323d')
        unlocked_level_rect = unlocked_level_text.get_rect(topleft=(16, 60))
        self.display_surface.blit(unlocked_level_text, unlocked_level_rect)

    def show_coins(self, amount):
        self.coin_amount = amount
        self.coin_timer.activate()

    def update_unlocked_level(self, unlocked_level):
