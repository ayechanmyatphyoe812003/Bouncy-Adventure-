...
class Overworld:
	...
	def setup(self, tmx_map, overworld_frames):
		...
		for obj in tmx_map.get_layer_by_name('Nodes'):
			...
			# Determine if the node should be unlocked based on game logic
			is_unlocked = obj.properties.get('is_unlocked', False)  # Adjust this based on your TMX file properties
			...
			if obj.name == 'Node':
				...
				Node(
					...
					is_unlocked=is_unlocked  # Pass is_unlocked to Node constructor
				)
